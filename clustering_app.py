...
all_features=['Country', 'BirthRate', 'BusinessTaxRate', 'CO2Emissions', 'GDP',
       'HealthExpCapita', 'InfantMortalityRate', 'InternetUsage',
       'LendingInterest', 'LifeExpectancyFemale', 'MobilePhoneUsage',
       'PopulationTotal']


# Feature ranges (from your provided image)
feature_ranges = {
    'BirthRate': (0.007, 0.053),
    'BusinessTaxRate': (27.5, 61.9),
    'CO2Emissions': (7.0, 104443.0),
    'GDP': (63101270000.0, 227359000000.0),
    'HealthExpCapita': (2.0, 1308.0),
    'InfantMortalityRate': (0.002, 0.11),
    'InternetUsage': (0.0, 1.0),
    'LendingInterest': (0.01, 0.159),
    'LifeExpectancyFemale': (39.0, 87.0),
    'MobilePhoneUsage': (0.0, 3.0),
    'PopulationTotal': (18876.0, 49261313.0)
}
